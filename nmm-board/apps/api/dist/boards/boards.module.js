...
exports.BoardsModule = BoardsModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([board_entity_1.Board, comment_entity_1.Comment]),
            auth_module_1.AuthModule,
        ],
        controllers: [boards_controller_1.BoardsController],
        providers: [boards_service_1.BoardsService, board_repository_1.BoardRepository, comment_repository_1.CommentRepository]
    })
], BoardsModule);
