...
__decorate([
    (0, typeorm_1.ManyToOne)(() => board_entity_1.Board, (board) => board.comments, { onDelete: 'CASCADE' }),
    __metadata("design:type", board_entity_1.Board)
], Comment.prototype, "board", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => user_entity_1.User, (user) => user.comments, { eager: false, onDelete: 'CASCADE' }),
